...
scent_categories = {
    "스트레스 완화 및 진정": {
        "keywords": ["스트레스", "불안", "긴장", "짜증", "힘듦", "지침","힘들고","짜증나고","민감해","민감","소외감","소외감들어","화남","화나요","화난다","힘듬","힘들다","질투","열등감"],
        "scents": ["라벤더", "일랑일랑", "화이트자스민 & 민트", "히노끼"],
        "effect": "불안과 스트레스를 해소하고 감정의 균형을 맞추는 데 도움을 줘요."
    },
    "기분 전환 및 활력 증진": {
        "keywords": ["우울", "기분 전환", "기쁘다", "상쾌함", "에너지", "활기","우울해","우울하고","행복","행복해","행복하고","상쾌해","속상","속상하다","속상함","속상해"],
        "scents": ["헤스페리데스 자몽", "프리지아", "화이트머스크"],
        "effect": "기분을 상쾌하게 만들어 활력을 주고 우울감을 해소하는 데 효과적이에요."
    },
    "정신적 집중 및 피로 회복": {
        "keywords": ["집중", "피곤", "피로", "무기력", "멍함", "졸림","졸려","졸리고","지침","지쳤어","지쳤음","슬픔","슬퍼","슬픈","공허해","공허함","공허","지루해","지루함","지루한"],
        "scents": ["로즈마리가든", "헤스페리데스 자몽"],
        "effect": "집중력을 높이고 피로를 해소해 머리를 맑게 해줘요."
    },
    "청량감 및 상쾌함": {
        "keywords": ["답답", "상쾌", "혼란", "복잡", "리프레시", "환기","답답해","답답하고","안좋음","더러워","똥같아"],
        "scents": ["클린웜코튼", "화이트자스민 & 민트"],
        "effect": "신선한 향이 마음을 정리하고 기분을 환기시켜줘요."
    },
    "감정적 안정 및 균형": {
        "keywords": ["혼란", "감정 기복", "불안정", "슬픔", "마음의 평화", "고요함","초조함","초조해","초초한 것 같아","좋음","좋다"],
